(ns advent-of-code-2020.day-23-old
  "Original solution for day 23 part 1. This was not efficient enough to
  run part 2, but I have kept it for historical reference about how my
  solution evolved.")
